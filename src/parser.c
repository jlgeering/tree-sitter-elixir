...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [107] = {
    ...
    [aux_sym_defmodule_repeat1] = STATE(138),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [425] = {.count = 1, .reusable = true}, REDUCE(sym_defmodule, 4),
  [427] = {.count = 1, .reusable = false}, REDUCE(sym_defmodule, 4),
  ...
  [503] = {.count = 1, .reusable = true}, REDUCE(sym_defmodule, 5),
  [505] = {.count = 1, .reusable = false}, REDUCE(sym_defmodule, 5),
  [507] = {.count = 1, .reusable = true}, REDUCE(aux_sym_defmodule_repeat1, 2),
  [509] = {.count = 2, .reusable = true}, REDUCE(aux_sym_defmodule_repeat1, 2), SHIFT_REPEAT(105),
  [512] = {.count = 2, .reusable = true}, REDUCE(aux_sym_defmodule_repeat1, 2), SHIFT_REPEAT(106),
